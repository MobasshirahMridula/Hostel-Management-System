...
public class StudentFees extends javax.swing.JFrame {
    ...
    public void tableDetails()
    {
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery(" select * from fees where RegNumber='"+RegNumber+"'");
            while(rs.next())
             {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Ammount to be Pay");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery(" select * from student where RegNumber='"+RegNumber+"' and status='living'");
            if(rs.first())
            {
            ...
            ResultSet rs1=st.executeQuery("select * from fees inner join student where student.status='living' and fees.month='"+month+"'and    fees.RegNumber='"+RegNumber+"' and student.RegNumber='"+RegNumber+"' ");
            if(rs1.first())
            {
